...
// Mudar Aqui o e-mail
$email_envio = "emiliaand_paula1@msn.com"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "e71954831"; // Senha do e-mail

$site_name = "Bikcraft"; // Nome do Site
$site_url = "www.bikcraft.com"; // URL do Site

$host_smtp = "sub4.mail.dreambos.com"; // HOST SMTP Ex: smtp.domain.com.br
